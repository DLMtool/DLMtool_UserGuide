...
The PMs are recylced if an odd number are provided:
```{r}
...
```{r}
NOAA_plot(MSE)
TradePlot(MSE, Lims=c(0.5, 0, 0.8, 0.5), PMlist=list("PNOF", "LTY", "P50", "AAVY"), Refs=list(AAVY=0.15))
```

See the [Plotting the MSE Results] section for examples on DLMtool plotting functions for the MSE object. 
