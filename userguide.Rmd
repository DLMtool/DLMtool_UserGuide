...
<!--chapter:end:06-Example_Complete_Workflow.Rmd-->
...
It is also possible to supply custom generated time-varing values for some parameters using the `cpars` slot. For example, time-varying natural mortality or selectivity patterns. These are referred to as *internal* custom parameters. 
...
<!--chapter:end:07-Advanced-DLMtool.Rmd-->
