...
### Discard Mortality
Since DLMtool V4.4 DLMtool can account for discarding of fish that are smaller than the size of retention by the fishery. See the [Discard Mortality] chapter for more information.
